...
KCM.SimpleKCM {
    ...
    property alias cfg_ownProcs: ownProcs.checked
    property alias cfg_userProcs: userProcs.checked
    property alias cfg_systemProcs: systemProcs.checked
    property alias cfg_allProcs: allProcs.checked
