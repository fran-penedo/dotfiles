...
files="bashrc Xresources emacs emacs-custom.el gitconfig gmrunrc rtorrent.rc xinitrc xmobarrc gitignore gntrc vimrc"    # list of files/folders to symlink in homedir
xmonad="xmonad.hs"
i3dotdir=~/.i3
i3dir=i3
