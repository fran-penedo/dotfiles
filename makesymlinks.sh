...
homedotdir=~
homedir=.
homeconfig="globalrc bashrc Xresources spacemacs gitconfig gmrunrc rtorrent.rc xinitrc xmobarrc gitignore gntrc vimrc Rprofile yaourtrc zshrc msmtprc offlineimap.py offlineimaprc tmux.conf tmux.conf.local ctags notmuch-config jrnl_config"
i3dotdir=~/.i3
i3dir=i3
